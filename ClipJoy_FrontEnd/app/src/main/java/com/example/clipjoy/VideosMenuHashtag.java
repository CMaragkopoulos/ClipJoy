...
public class VideosMenuHashtag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videos_menu_hashtag);

        txtParam = (TextView) findViewById(R.id.txtParamHash);

        Intent intent = getIntent();
        hashtag = intent.getStringExtra("hashtag"); //λαμβάνουμε το hashtag που μας δώσαν στο προηγούμενο Activity
        ...
        txtParam.setText(message + " " + hashtag);
